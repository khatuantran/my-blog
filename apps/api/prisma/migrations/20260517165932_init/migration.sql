...
-- CreateEnum
CREATE TYPE "Mood" AS ENUM ('HAPPY', 'EXCITED', 'THOUGHTFUL', 'CALM', 'SAD', 'GRATEFUL', 'ANGRY');

-- CreateEnum
CREATE TYPE "FileType" AS ENUM ('PDF', 'DOC', 'DOCX', 'XLS', 'XLSX', 'TXT', 'CSV');
...
-- CreateIndex
CREATE UNIQUE INDEX "Like_postId_anonymousId_key" ON "Like"("postId", "anonymousId");
...
-- CreateIndex
CREATE UNIQUE INDEX "CommentLike_commentId_anonymousId_key" ON "CommentLike"("commentId", "anonymousId");
...
-- CreateIndex
CREATE INDEX "PostView_anonymousId_postId_viewedAt_idx" ON "PostView"("anonymousId", "postId", "viewedAt");

-- CreateIndex
CREATE INDEX "AnonymousSession_lastActive_idx" ON "AnonymousSession"("lastActive");
