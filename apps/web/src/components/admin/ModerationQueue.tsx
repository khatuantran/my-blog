...
export function ModerationQueue() {
  ...
  if (isError) {
    return (
      <div className="rounded-md border border-red/40 bg-red/[0.05] p-4 font-mono text-mono-xs text-red">
  ...
  return (
    <div className="space-y-2" data-testid="moderation-queue">
      <div className="font-mono text-mono-xs text-yel">● {data?.total ?? items.length} pending</div>
      {items.map((c) => (
        <div
          key={c.id}
        ...
        >
          <div className="min-w-0 flex-1">
            <div className="mb-1 flex items-center gap-2 font-mono text-mono-xs text-tm">
            ...
            <div className="truncate font-mono text-mono-xs text-td">
          ...
          <div className="flex shrink-0 gap-1.5">
            <button
              ...
              className="rounded-sm border border-grn/40 bg-grn/10 px-2 py-1 font-mono text-mono-xs text-grn transition-colors hover:bg-grn/20 disabled:opacity-50"
            >
              ✓ Approve
            </button>
            <button
              ...
              className="rounded-sm border border-red/40 bg-red/10 px-2 py-1 font-mono text-mono-xs text-red transition-colors hover:bg-red/20 disabled:opacity-50"
            >
              ✕ Delete
            </button>
          </div>
