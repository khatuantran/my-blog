...
- POST `/posts/:id/reactions`, DELETE `/posts/:id/reactions`, POST `/comments/:id/like` (legacy POST `/posts/:id/like` → 410 Gone, không còn throttle)
...
| Method | Path                           | Auth              | FR                               | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------ | ------------------------------ | ----------------- | -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| GET    | `/users/:id`                   | user              | FR-01, FR-11.1                   | Get user by id. Role-aware: admin hoặc self → full `UserResponseDto` (gồm `email`, `avatarPublicId`); viewer khác → `toPublicUserResponse` (email/avatarPublicId = null). Guard mặc định `JwtAuthGuard` (authed required). Response 200 `UserResponseDto`. 401 anon / 404 `USER_NOT_FOUND`. (Lưu ý: route `:id` declare SAU `me/avatar/*` + `by-username/:username` + `:id/stats` để Nest match đúng. KHÔNG có route `/users/me` — `/auth/me` dùng cho self.)                                                                                                                                                                                                                                                                                         |
