...
> **Status note 2026-05-25:** Phase 1 (base tokens + screen font sync) DONE — 9 commits implement 7 base tokens + fix font drift trên 6 screens (Admin/TopBar/Profile/PostContent/TerminalCard/Search+Tags). Remaining scope vẫn TODO: Z-index 9 tiers + Shadow recipes 10 tokens + Letter-spacing + Line-height + v2.1 variant tokens (text-h1-hero/input-hero/display-sm/mono-tiny/display-glyph).
